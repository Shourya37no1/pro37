...
function setup() {
 canvas= createCanvas(displayWidth-20,displayHeight-30);
    ...
    trex = createSprite(10,100,30,30);
  
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collided", trex_collided);
  trex.scale = 0.5;
  
  ground = createSprite(200,180,1800,20);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(camera.position.x+300,165,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(camera.position.x+300, 165,40,10);
    //obstacle.debug = true;
